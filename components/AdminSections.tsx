  ...
  return (
    <div className="glass-panel" style={{ padding: "1.5rem" }}>
      <div style={{ display: "flex", gap: "0.75rem", marginBottom: "1.5rem", flexWrap: "wrap", alignItems: "flex-end" }}>
        <input
          type="text"
          placeholder="New section name (e.g. Main, Explore)"
          value={newName}
      ...
      <p style={{ fontSize: "0.85rem", color: "var(--gold-dim)", marginBottom: "1rem" }}>
        Sections are the menu headers in the sidebar (e.g. Main, Explore, Culinary Traveler). Create new ones and assign categories to them in the Categories tab.
      </p>
