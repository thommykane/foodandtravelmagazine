...
export default function AdminAnnouncements() {
  const [announcements, setAnnouncements] = useState<{ id: string; title: string; body: string; active: boolean; createdAt: string }[]>([]);
  ...
  async function handleDelete(id: string) {
    ...
    const res = await fetch(`/api/admin/announcements?id=${id}`, { method: "DELETE", credentials: "include" });
  ...
  return (
    <div className="glass-panel" style={{ padding: "1.5rem" }}>
      <div style={{ marginBottom: "1.5rem" }}>
        <h3 style={{ fontSize: "1rem", color: "var(--mag-primary, var(--gold))", marginBottom: "0.75rem" }}>
          ...
          {announcements.map((a) => (
            <div
              ...
              style={{
                ...
                borderLeft: a.active ? "3px solid var(--mag-primary, var(--gold))" : "3px solid var(--gold-dim)",
              }}
            >
